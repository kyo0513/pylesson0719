...
def move_missile(scrn):
    for i in range(MISSILE_MAX):
        if msl_f[i] == True:
            ...
            scrn.blit(img_rz,[msl_x[i]-img_rz.get_width()/2,
        ...
        if emy_f[i] == True:
            ...
            if emy_type[i] < EMY_BOSS:
                ...
                if emy_count[i] == 0:
                    ...
                    if emy_x[i] > 760:
                        for j in range(0,10):
                            set_enemy(emy_x[i],emy_y[i]+80,j*20,
                                    EMY_BULLET,6,0)
                            emy_count[i] = 1

                if emy_shield[i] < 100 and tmr % 30 == 0:
                    set_enemy(emy_x[i],emy_y[i]+80,random.
                            randint(60,120),EMY_BULLET,6,0)
            ...
            if emy_type[i] != EMY_BULLET:
                ...
                for n in range(MISSILE_MAX):
                    if msl_f[n] == True and get_dis(emy_x[i],emy_y[i],
                            msl_x[n],msl_y[n]) < r**2:
                        msl_f[n] = False
            ...
            scrn.blit(img_rz,[emy_x[i]-img_rz.get_width()/2,
...
def main(): # メインループ
    ...
    while True:
        ...
        if idx == 0: #タイトル
            ...
            screen.blit(img_rz,[480-img_rz.get_width()/2,
                280-img_rz.get_height()/2])
